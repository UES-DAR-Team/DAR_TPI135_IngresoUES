...
public class CorseResponseFilter implements ContainerResponseFilter {
    ...
    public void filter(ContainerRequestContext requestContext, ContainerResponseContext responseContext) throws IOException {
        ...
        headers.add("Access-Control-Allow-Headers", getRequestAllowedHeaders(responseContext));
        ...
        headers.add("x-response-by", "CorseResponseFilter");

    }

    String getRequestAllowedHeaders(ContainerResponseContext responseContext) {
