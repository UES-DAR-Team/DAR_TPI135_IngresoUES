...
@Path("distractor")
public class DistractorResource extends AbstractResource implements Serializable {
    @Inject
    ...
    public Response findById(@PathParam("id") UUID id) {
        ...
        return notFound(id.toString(), "Distractor");
    }
    ...
    public Response deleteById(@PathParam("id") UUID id) {
        ...
        Distractor encontrados = distractorDAO.findById(id);
        if (encontrados == null) return notFound(id.toString(), "Distractor");
