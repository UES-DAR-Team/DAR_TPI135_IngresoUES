...
public class DistractorAreaConocimientoResourceSystem extends BaseIntegrationAbstract {
    ...
    private static final UUID ID_AREA_SEED = UUID.fromString("a1000000-0000-0000-0000-000000000003");

    private static final UUID ID_DISTRACTOR_SEED = UUID.fromString("d4000000-0000-0000-0000-000000000013");

    private static final UUID ID_INEXISTENTE = UUID.randomUUID();
    private static final int FIRST = 0;
    private static final int MAX = 10;
    private static final int INVALID_FIRST = -1;
    private static final int INVALID_MAX = 0;
    ...
    class FindRange {
        ...
        void responde400_cuandoFirstYMaxInvalidos() {
            Response response = target
                    ...
                    .path(ID_AREA_SEED.toString())
                    .path(PATH_DISTRACTOR)
                    .queryParam("first", INVALID_FIRST)
                    .queryParam("max", INVALID_MAX)
                    .request(MediaType.APPLICATION_JSON)
                    .get();
    ...
    class Create {
        ...
        @Order(4)
        @Test
        void responde422_cuandoIdDistractorEsNulo() {
            Response response = target
                    .path(PATH_AREA_CONOCIMIENTO)
                    .path(ID_AREA_SEED.toString())
                    .path(PATH_DISTRACTOR)
            ...
            assertEquals(422, response.getStatus(), "Debe retornar 422 cuando idDistractor no se provee en el body");
            assertNotNull(response.getHeaderString("Missing-parameter"));
        }
    ...
    class FindById {
        ...
        void responde200_cuandoIdExiste() {
            Response response = target
                    ...
                    .path(ID_AREA_SEED.toString())
                    .path(PATH_DISTRACTOR)
                    .path(ID_DISTRACTOR_SEED.toString())
                    .request(MediaType.APPLICATION_JSON)
                    .get();

            assertEquals(200, response.getStatus(), "Debe retornar 200 cuando el idDistractor existe y está asociado al área");
        ...
        void responde404_cuandoIdNoExiste() {
            ...
            assertEquals(404, response.getStatus(), "Debe retornar 404 cuando el idDistractor no está asociado al área");
