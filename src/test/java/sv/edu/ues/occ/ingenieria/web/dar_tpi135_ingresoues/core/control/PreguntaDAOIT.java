...
public class PreguntaDAOIT extends BaseIntegrationAbstract {

    private EntityManager em;
    private PreguntaDAO cut;
    ...
    public void findByCoincidenciaTextoHappy() {
        List<Pregunta> registro = cut.findByCoincidenciaTexto("¿Cuál es el valor de la expresión 3² + 4²?", 0, 10);
    ...
    public void findByCoincidenciaTexto_FirstAndMaxInvalidosDevuelveIllegalArgumentException() {
        assertThrows(IllegalArgumentException.class, () -> {
            cut.findByCoincidenciaTexto("¿Cuál es el valor de la expresión 3² + 4²?", -1, 10);
        });

        assertThrows(IllegalArgumentException.class, () -> {
            cut.findByCoincidenciaTexto("¿Cuál es el valor de la expresión 3² + 4²?", 0, -5);
        });
    }
    ...
    public void findByCoincidenciaTexto_falloDBDevuelveIllegalStateException() {
        assertThrows(IllegalStateException.class, () -> {
            daoNoEm.findByCoincidenciaTexto("¿Cuál es el valor de la expresión 3² + 4²?", 0, 10);
        });
    }
